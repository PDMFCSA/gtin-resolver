...
function getFixedUrl (server) {
    ...
    server.put("/registerFixedURLs", require("../../../opendsu-sdk/modules/apihub/http-wrapper/utils/middlewares").bodyReaderMiddleware);
    ...
    server.put("/activateFixedURL", require("../../../opendsu-sdk/modules/apihub/http-wrapper/utils/middlewares").bodyReaderMiddleware);
    ...
    server.put("/deactivateFixedURL", require("../../../opendsu-sdk/modules/apihub/http-wrapper/utils/middlewares").bodyReaderMiddleware);
