...
function Product(enclave, domain, subdomain, gtin, version) {
    ...
    instance.persist = async (auditContext) => {
        ...
        try{
            ...
            $$.promisify(require("./../../mappings/utils.js").activateGtinOwnerFixedUrl)(undefined, domain, gtin,null);
            $$.promisify(require("./../../mappings/utils.js").activateLeafletFixedUrl)(undefined, domain, gtin,null);
        }catch(err){
