...
module.exports = function (server) {
    ...
    // BATCH PUT
    server.put("/integration/epi/:gtin/:batchNumber/:language/:epiType/:epiMarket", requestBodyJSONMiddleware);
    server.put("/integration/epi/:gtin/:batchNumber/:language/:epiType/:epiMarket", basicPreValidationMiddleware);
    server.put("/integration/epi/:gtin/:batchNumber/:language/:epiType/:epiMarket", batchEpiHandler);
